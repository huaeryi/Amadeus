...
examples:
  run_pwn.sh agent/AAAgent/challenges/fsb
  run_pwn.sh agent/AAAgent/challenges/fsb local
  run_pwn.sh agent/AAAgent/challenges/fsb remote 127.0.0.1 5000
  run_pwn.sh agent/AAAgent/challenges/fsb patched
  run_pwn.sh agent/AAAgent/challenges/fsb info
