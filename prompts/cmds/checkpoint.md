...
推荐节奏：
- 简单题通常 3 到 5 个 checkpoint：`env-profiled`、`entrypoints-mapped`、`<specific-capability>-works`、`final-result-verified`
- 中等题通常 5 到 8 个 checkpoint：按 leak、write、oracle、约束、认证绕过、RCE、远程适配等具体事实拆分
