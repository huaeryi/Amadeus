帮我把这个 CTF 题目爬取到 `{{root_name}}/challenges/`：
...
4. 根据题目标题创建 `{{root_name}}/challenges/<title>` 目录；标题含中文、空格或符号时保留可读名称
5. 运行 `{{root_name}}/bin/init_challenge.sh {{root_name}}/challenges/<title>`
