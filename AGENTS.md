...
- `challenges/AGENTS.md` contains the generic pwn workflow that Codex should follow inside `agent/AAAgent/challenges/<name>`.

When solving a pwn challenge under `agent/AAAgent/challenges/`, prefer the challenge-local workflow in `challenges/AGENTS.md`.
